...
import common.toolkit.java.entity.entity.DateFormat;
import common.toolkit.java.entity.exception.IllegalParamException;
...
public class DateUtil {
    ...
    /**
     * Convert java.util.Date to String<br>
     * @return like format yyyyMMddHHmmss.
     */
    public static String convertDate2DbString(Date date) {
        return DateUtil.convertDate2String(date, DateFormat.DbDateTime);
    }
    ...
    /**
     * 将"yyyyMMddHHmmss"格式时间字符串转换成"yyyy-MM-dd HH:mm:ss"格式的字符串.
     * //@param strDate stringDate
     * @return String
     */
    public static String convertDbString2String(String dateStr) {
        Date date = DateUtil.convertString2Date(dateStr, DateFormat.DbDateTime.getFormat());
        return DateUtil.convertDate2String(date);
    }

    /**
     * 将"yyyy-MM-dd HH:mm:ss"格式时间字符串转换成"yyyyMMddHHmmss"格式的字符串.
     * //@param strDate stringDate
     * @return String
     */
    public static String convertString2DbString(String dateStr) {
        Date date = DateUtil.convertString2Date(dateStr, DateFormat.DateTime.getFormat());
        return DateUtil.convertDate2DbString(date);
    }
     ...
     * @return like format yyyy-MM-dd HH:mm:ss.
     */
    public static String convertLong2String(Long longFormatDateTime, String dateFormat) throws IllegalParamException {
    ...
    public static long getTimeMillisToAfterDaysHour(int days, int hourOfTomorrow) throws Exception {
        ...
        Calendar calendarOfTomorrow = new GregorianCalendar(yearOfTomorrow, monthOfTomorrow, dayOfTomorrow,
                hourOfTomorrow, 0, 0);
    ...
    /**
     * Get before day of current month
     * @return Date
     */
    ...
    /**
     * Get first year of current month
     * @return Date
     */
    ...
    /**
     * Get current year of current year
     * @return Date
     */
