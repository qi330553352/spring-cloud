package common.toolkit.java.entity.util.db;

import com.mchange.v2.c3p0.ComboPooledDataSource;
import common.toolkit.java.entity.entity.db.DBConnectionResource;
...
public class C3p0Util {
    ...
    public C3p0Util(String driverClassName, String dbJDBCUrl, String characterEncoding, String username,
    ...
    private static void init() throws Exception {
        ...
        try {
            ...
            LOG.warn("Start init datasource[driverName:" + driverClassName + ", url: " + C3p0Util.dbJDBCUrl
    ...
    private static synchronized Connection getConnection() throws Exception {
        ...
        if (null != C3p0Util.dataSource) {
            try {
                ...
                throw new Exception("Can't create conncetion, please make sure if database is available, "
