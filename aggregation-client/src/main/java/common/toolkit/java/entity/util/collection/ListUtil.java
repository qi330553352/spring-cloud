package common.toolkit.java.entity.util.collection;
...
import common.toolkit.java.entity.util.number.NumberUtil;
import common.toolkit.java.entity.util.number.RandomUtil;
